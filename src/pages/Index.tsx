...
export default function Index() {
  ...
  const beforeItems = [
    { icon: "AlertTriangle", text: "Простои миксера — срыв сроков бетонирования объекта" },
    { icon: "TrendingUp", text: "Расходы на ремонт съедают прибыль с каждого рейса" },
    { icon: "Clock", text: "Поиск запчастей на Scania занимает недели" },
    { icon: "Wrench", text: "Барабан, редуктор и гидравлика изношены до предела" },
  ]

  const afterItems = [
    { icon: "Shield", text: "Миксер работает без аварийных остановок" },
    { icon: "TrendingUp", text: "Ресурс машины продлён ещё на 5–10 лет" },
    { icon: "Clock", text: "Сдача объектов в срок — репутация компании защищена" },
  ...
  const services = [
    {
      ...
      desc: "Полный осмотр смесительного барабана, редуктора, гидравлики и шасси Scania. Подробный отчёт о состоянии узлов.",
    },
    {
      icon: "Settings",
      title: "Восстановление барабана и привода",
      desc: "Замена лопастей, ремонт горловины и уплотнений барабана. Ревизия и восстановление редуктора привода.",
    },
    {
      icon: "Shield",
      title: "Ремонт гидравлической системы",
      desc: "Замена гидромотора, насосов, распределителей и шлангов. Настройка давления по заводским параметрам.",
    },
    {
      icon: "Truck",
          ...
          <div className="text-center px-4">
            ...
            >
              ...
              <h1 className="text-4xl font-bold text-white md:text-6xl font-heading leading-tight">
                Автобетоносмеситель Scania<br />
                <span className="text-orange-400">живёт ещё 10 лет</span>
              </h1>
              <p className="mt-5 text-lg text-gray-300 md:text-xl max-w-2xl mx-auto">
                Полное восстановление 4-осных миксеров с пробегом более 10 лет.<br />
                Барабан, редуктор, гидравлика и шасси — под ключ.
              </p>
